...
|---|---|---|
| Esplorare | un banco mostra il residuo dell'ultimo sacrificio, ma nessuno riconosce la persona | capire che il segno non è una profezia completa |
...
## Indizi nel luogo
- Core clue presente: il custode amministra il rito, non è automaticamente la vittima e non è il creatore della presenza
